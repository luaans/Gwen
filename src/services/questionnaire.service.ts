...
export async function submitQuestionnaire(
  ...
  const questionnaire = await Questionnaire.create({
    ...
    personality: {
      description: input.personality.description.trim(),
      definingTraits: input.personality.definingTraits.trim(),
      whatMakesHappy: input.personality.whatMakesHappy.trim(),
      whatIrritates: input.personality.whatIrritates.trim(),
    },
    tastes: {
      favoriteGames: emptyToUndefined(input.tastes.favoriteGames),
      favoriteMovies: emptyToUndefined(input.tastes.favoriteMovies),
      favoriteSeries: emptyToUndefined(input.tastes.favoriteSeries),
      favoriteBooks: emptyToUndefined(input.tastes.favoriteBooks),
      favoriteArtists: emptyToUndefined(input.tastes.favoriteArtists),
      favoriteFood: emptyToUndefined(input.tastes.favoriteFood),
      hobbies: emptyToUndefined(input.tastes.hobbies),
    },
    communication: {
